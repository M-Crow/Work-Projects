...
root_folder = mapi.Folders[#your folder location].Folders[#your folder location]]
...
for message in delta_date_time:
   if message.subject.startswith(#insert word you would like to search for):
      count += 1
...
text_file = open(#where you want the file to be created and saved\\{0}.txt".format(current_time), "w")
